...
class FastDVDnet(nn.Module):
	...
	Inputs of forward():
		xn: input frames of dim [N, C, H, W], (C=3 RGB)
		noise_map1: array with noise map of dim [N, 1, H, W] for denoise bloc1 temp1 -> ut-1
		noise_map2: array with noise map of dim [N, 1, H, W] for denoise bloc2 temp1 et temp2 -> ut 
		noise_map3: array with noise map of dim [N, 1, H, W] for denoise bloc3 temp1 -> ut+1
	"""
	...
	def forward(self, x, noise_map1, noise_map2, noise_map3):
		'''Args:
		...
		# First stage
		x20 = self.temp1(x0, x1, x2, noise_map1)
		x21 = self.temp1(x1, x2, x3, noise_map2)
		x22 = self.temp1(x2, x3, x4, noise_map3)

		#Second stage
		x = self.temp2(x20, x21, x22, noise_map2)
