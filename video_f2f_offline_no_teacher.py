...
class Loss(nn.Module):
    ...
    def forward(self, input1, prev_frame1, flow1, mask1_0, exclusive_mask1):
        ...
        self.loss = self.criterion(exclusive_mask1*Mask1*warped1, exclusive_mask1*Mask1*prev1)  
...
def MF2F(**args):
    ...
    for training in range(args['nb_trainings']):
        ...
        print(color + "Paires = {:03d}-{:03d}, PSNR training stack = {:5.3f}, PSNR eval stack = {:5.3f}, SSIM training stack = {:4.3f}, SSIM eval stack = {:4.3f}   {:1d}    {:04d}/{:04d}".format(i-1, i, quant_training_stack, quant_eval_stack, ssim_training, ssim_eval, value, training, args['nb_trainings']-1))
    ...
    for i in range(args['first']+4, args['last']-3):
        ...
        print("Itération = {:03d}, PSNR training stack = {:5.3f}, PSNR eval stack = {:5.3f}, SSIM training stack = {:4.3f}, SSIM eval stack = {:4.3f}   {:1d}".format(i, quant_training_stack, quant_eval_stack, ssim_training, ssim_eval, value))
