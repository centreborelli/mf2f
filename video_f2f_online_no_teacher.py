...
def MF2F(**args):
    ...
    for i in range(args['first']+4, args['last']-3):
        ...
        print("Itération = {:02d}, PSNR training stack = {:5.3f}, PSNR eval stack = {:5.3f}, SSIM training stack = {:4.3f}, SSIM eval stack = {:4.3f}   {:1d}".format(i, quant_training_stack, quant_eval_stack, ssim_training, ssim_eval, value))
...
if __name__ == "__main__":
    # Parse arguments
    parser = argparse.ArgumentParser(description="MF2F online no teacher")
